...
jQuery(document).ready(function($){
  ...
  $('.btn:not(.btn--form,#btn--pay)').click( function(e){
    e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    _this
                        ...
                        .prop( 'disabled', true );
                    _this[0].reset();
                    _this.find("span.form__success").css({'display': 'block'});
                }
            });
        }
        event.preventDefault();
    ...
    var payForm = $('form.js-payform');
    var rfEuro = $('input#rf-euro');
    var rfAll = $('input#rf-all');
    var world = $('input#world');
    var deliveryPriceInput = $('input[type=radio][name="region"]');
    var deliveryPrice = $('input[type=radio][name="region"]:checked', '.js-payform').data('price');
    var pricePlace = $('span.js-pricepay');
    var yandexMoneySum = $('.js-ym-sum');


    payForm.change(function () {
        var deliveryPrice =  $('input[type=radio][name="region"]:checked').data('price');
        var finalPrice = 1800 + deliveryPrice;
        pricePlace.text(finalPrice);
        console.log(finalPrice);
        yandexMoneySum.val(finalPrice);
    });
