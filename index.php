  ...
  <body>
          ...
          <div class="row">
            <div class="col-xs-12 col-lg-7 offset-lg-4">
              <div class="order-now">
                ...
                <form name="pageForm" id="form1" class="order-now__form" method="post" action="form.php" onsubmit="yaCounter<?php echo $app['yandexMetrika'] ?>.reachGoal('orderOnPage'); return true;">
    ...
    <div class="overlay">
      ...
      <div class="overlay__wrapper">
        ...
        <form name="modalForm" id="form2" class="form" method="post" action="form.php" onsubmit="yaCounter<?php echo $app['yandexMetrika'] ?>.reachGoal('orderInModal'); return true;">
